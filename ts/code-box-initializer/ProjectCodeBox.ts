...
class ProjectCodeBox extends CodeBox {
    ...
    /** Stores paths for initialized files (codes). Used when initialiazing code box to prevent duplicate codes. */
    ...
    constructor(codeBoxElement: HTMLElement, parentCodeBox: ProjectCodeBox | null = null) {
        ...
        // copy all code elements from parent code box
        if (parentCodeBox) {
    ...
    protected validateCodeElement(codeElement: HTMLElement): boolean {
        ...
        // if file path is already used for different code element
