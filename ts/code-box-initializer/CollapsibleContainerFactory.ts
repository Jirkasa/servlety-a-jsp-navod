...
class CollapsibleContainerFactory {
    ...
    public static createFolder(name: string, folderPath: string, projectId: string, openedOnInit: boolean) : CollapsibleContainer {
        return new CollapsibleContainer(
    ...
    public static createJavaPackage(name: string, projectId: string, openedOnInit: boolean) : CollapsibleContainer {
        return new CollapsibleContainer(
